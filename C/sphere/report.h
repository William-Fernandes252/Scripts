...
/*
    check_separator:    Look for a separator for a csv file in the first line of the
                        input file.      
*/
char check_separator(FILE *const report);

/*
    write_data:     Depending on the chosen option, either writes the data referent to 
                    the number of collisions or the total flux in the given stream. If 
                    it is a new file, writes the collumns labels.
*/
